...
def main():
    ...
    assert dataset_type in ['VOC', 'COCO', 'CityScapes', 'ADE20K', 'Carla']
    if dataset_type == 'CityScapes' or dataset_type == 'Carla': 
...
def parse_arguments():
    ...
    parser.add_argument('-c', '--config', default='config_Carla.json',type=str,
                        help='The config used to train the model')
    parser.add_argument('-mo', '--mode', default='multiscale', type=str,
                        help='Mode used for prediction: either [multiscale, sliding]')
    parser.add_argument('-m', '--model', default='saved/best_model.pth', type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    parser.add_argument('-i', '--images', default='/space1/zhaoqing/dataset/Carla_seg/img/', type=str,
                        help='Path to the images to be segmented')
    parser.add_argument('-o', '--output', default='test_result/', type=str,  
                        help='Output Path')
